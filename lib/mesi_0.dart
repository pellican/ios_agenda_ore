                        ...
                        child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Container(height: 60,width:double.infinity,
                              ...
                              child: Padding(padding: const EdgeInsets.only(left: 20,right: 10),
                                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children:[ Text(mesi_anno[index]+anno,style: TextStyle(fontSize: 20)),
                            ...
                            Padding( padding: const EdgeInsets.only(left: 20,right: 20),
                              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [ Text('Lavorato',style: TextStyle(fontSize: 20)),
                                  Text(dati != null ? dati.lavorato : '',style: TextStyle(fontSize: 20),)
                              ])),
                            Padding( padding: const EdgeInsets.only(left: 20,right: 20),
                                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [ Text('Pagato',style: TextStyle(fontSize: 20)),
                                      ...
                                      else Text(dati != null ? dati.pagato : '',style: TextStyle(fontSize: 20),),

                                    ])),

                            Padding( padding: const EdgeInsets.only(left: 20,right: 20),
                             child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                               children: [Text('Resto',style: TextStyle(fontSize: 20)),
                                Text(dati != null ? dati.resto : '',style: TextStyle(fontSize: 20),)
                              ],
                            ),),
